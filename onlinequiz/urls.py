...
urlpatterns = [
    ...
    path('user_attendance', views.quiz_attendance),
...
path('login_face', views.login_face),
    ...
    path('sendimage/', views.receive_images),
    path('sendtrain/', views.receive_train),
    path('sendlogin/', views.recieve_login_face),
    path('recognize/camera/', views.recognize_camera),
    path('recognizephoto/', views.receive_recognize),
    path('recognize/photo/', views.recognize_photo),
    path('attendance/', views.attendance),
    path('api/attendance/', views.AttendanceRecord.as_view()),
    path('capture_signup/',views.capture_user),
    path('sms',views.number),
    # Assignments 
