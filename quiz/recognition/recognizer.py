...
from quiz.recognition.trainer import Trainer
...
class Recognizer:
    ...
    def __init__(self, recognizer_filename, source, max_width, max_height, threshold=None):
        ...
        self.lbph_rec.save("static/trained_lbph.yml")
        self.eigenface_rec.save("static/trained_eigenface.yml")
        self.fisherface_rec.save("static/trained_fisherface.yml")
   ...
   #     res = []
    ...
    def predict(self, *grays):
        ...
        for face_encoding in face_encodings:   #face recognition start
            match = face_recognition.compare_faces(self.known_faces, face_encoding, tolerance=0.34)
        print(match)
        id=0
